...
public class Spring : MonoBehaviour
{
	...
	public static float mKs = 0.1f, mKd = 0.01f, mKsSh = 0.05f;
...
*/
	...
	{
		return GetStructureForce (v, mAtom1, mStartDistance1) + GetStructureForce (v, mAtom2, mStartDistance2) +
		GetStructureForce (v, mAtom3, mStartDistance3) + GetStructureForce (v, mAtom4, mStartDistance4)
			+GetShearForce(v,mAtom5,mStartDistance5)+GetShearForce(v,mAtom6,mStartDistance6)+
			GetShearForce(v,mAtom7,mStartDistance7)+GetShearForce(v,mAtom8,mStartDistance8);
